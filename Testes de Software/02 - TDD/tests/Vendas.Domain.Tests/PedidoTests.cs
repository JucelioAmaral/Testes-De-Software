...
using System.Linq;
using Xunit;
using static Vendas.Domain.Pedido;
...
namespace Vendas.Domain.Tests
{
    public class PedidoTests
    {
        ...
        [Trait("Categoria", "Vendas - Pedido")]
        public void RemoverItemPedido_ItemUnidadeAcimaDoPermitido_DeveRetornarException()
        {
            //Arrange
            var pedido = Pedido.PedidoFactory.NovoPedidoRascunho(Guid.NewGuid());
        ...
        public void AplicarVoucher_VoucherTipoPercentualDesconto_DeveDescontarDoValorTotal()
        {
            ...
            var voucher = new Voucher("PROMO-15-YEAR", 15, null, 1,
